...
def allocate_memory(memory_blocks, required_memory):
    """
    Allocates the smallest available block that can fit the required memory.
    :param memory_blocks: Dictionary of memory blocks.
...
def main():
    ...
    while True:
        ...
        if required_memory == 0:
            ...
            break
        allocate_memory(memory_blocks, required_memory)
        display_memory(memory_blocks)
